...
def main():
    ...
    def start_new_level():
        ...
        return maze, player_pos, timer, hint_system, obstacles, maze_update_timer, settings
    ...
    while running:
        ...
        if game_state == "menu":
            ...
            instructions = [
                ...
                "Press H for hints (limited to 3 per level).",
                "",
                "Controls:",
                "- Arrow keys to move",
                "- H for hint",
            ...
            for i, line in enumerate(instructions):
                ...
                screen.blit(instr, (WIDTH//2 - instr.get_width()//2, HEIGHT//3 + i*30))
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.KEYDOWN:
                    if event.key == pygame.K_SPACE:
                        game_state = "playing"
                        maze, player_pos, timer, hint_system, obstacles, maze_update_timer, settings = start_new_level()
            ...
            if moved:
                ...
                for obstacle in obstacles:
                    if player_pos == list(obstacle.position):
